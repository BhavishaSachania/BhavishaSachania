...
public class Operation implements FileInterface  {
	List<String> retrieve= new ArrayList<String>();
	File[] files = new File("C:\\Users\\bhavisha.sachania\\eclipse-workspace\\Virtual key").listFiles();
	@Override
	...
	public void searchFile() {
		...
		try {	
			Scanner scan= new Scanner(System.in);
			File directory = new File("C:\\Users\\bhavisha.sachania\\eclipse-workspace\\Virtual key");
